...
?>
<!doctype html>
<html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Contabilidad</title><link rel="stylesheet" href="<?= e(app_url('assets/css/styles.css')) ?>"></head>
<body><div class="container">
<div class="topbar"><h1>Contabilidad</h1><a class="btn" style="width:auto;padding:.5rem 1rem;" href="<?= e(app_url('admin/dashboard.php')) ?>">Volver</a></div>
