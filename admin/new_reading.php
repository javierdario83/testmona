...
if ($step === '1') {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        header('Location: ' . app_url('admin/new_reading.php?step=2'));
        exit;
    }
    ?>
    <!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Nueva lectura</title><link rel="stylesheet" href="<?= e(app_url('assets/css/styles.css')) ?>"></head><body><div class="container" style="max-width:820px;">
    ...
    </div><a class="btn" style="width:auto;padding:.5rem 1rem;" href="<?= e(app_url('admin/dashboard.php')) ?>">Volver</a>
    </div></body></html>
    <?php
    exit;
}
...
if (!$draft) {
    header('Location: ' . app_url('admin/new_reading.php'));
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        header('Location: ' . app_url('public/client_view.php') . '?code=' . urlencode($draft['correlative']));
        exit;
    } catch (Throwable $e) {
        $pdo->rollBack();
        $error = $e->getMessage();
...
?>
<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Seleccionar cartas</title><link rel="stylesheet" href="<?= e(app_url('assets/css/styles.css')) ?>"></head><body><div class="container">
<div class="topbar"><h1>Lectura <?= e($draft['correlative']) ?> (<?= e($pkg['label']) ?>)</h1><a class="btn" style="width:auto;padding:.5rem 1rem;" href="<?= e(app_url('admin/new_reading.php')) ?>">Cancelar</a></div>
